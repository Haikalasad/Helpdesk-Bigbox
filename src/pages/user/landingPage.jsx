      ...
      <section className="hero-section min-h-full bg-white p-14">
        <div className="container mx-auto lg:flex-row items-center relative z-10">
          <div className="flex flex-col justify-center items-center text-center lg:pr-10 m-12">
            ...
            {/* Two boxes section */}
            <div className="flex flex-col lg:flex-row justify-center items-center mt-12 gap-6 w-full max-w-5xl">
              {/* Left box: Buat Tiket Baru */}
              <div className="bg-white text-[#0549CF] p-8 rounded-xl shadow-md w-full lg:w-1/2 flex flex-1 h-auto text-left">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-4">Buat Tiket Baru</h2>
                  <p className="text-lg mb-6 max-w-lg">
                    Buat tiket baru untuk pertanyaan, masukan, atau keluhan. Kami siap membantu!
                  </p>
                  <button onClick={handleCreateTicketClick} className="bg-[#0549CF] text-white font-semibold py-2 px-6 rounded-full shadow-md hover:bg-[#033a9a]">
                    Buat Tiket Baru
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white text-[#0549CF] p-8 rounded-xl shadow-md w-full lg:w-1/2 flex flex-1 h-auto text-left">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-4">Cek Status Tiket</h2>
                  <p className="text-lg mb-6 max-w-lg">
