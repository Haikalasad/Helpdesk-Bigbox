...
const landingPage = () => {
    return (
        ...
        <section className="hero-section bg-white ">
            <div className="container mx-auto flex flex-col lg:flex-row items-center relative z-10">
                <div className="flex-1 text-center lg:text-left lg:pr-10 mb-8 relative z-10">
                    <h1 className="text-4xl lg:text-5xl font-bold mb-8 tracking-wider ">
                        Penyedia <span className="text-[#FF931E]">Solusi AI</span> Terkemuka di Indonesia
                    </h1>
                    <p className="text-md mb-8 max-w-lg lg:max-w-xl mx-auto lg:mx-0 tracking-wider">
                    ...
                    <div className="flex justify-center lg:justify-start space-x-4">
                        <a
                            href="/signup"
                            className="inline-block bg-[#1E48C7] hover:bg-[#0E329F] text-base text-white font-medium py-4 px-7 rounded-md"
                        >
                            Jelajahi Bigbox AI
                        </a>
                        <a
                            href="/learn-more"
                            className="inline-block border border-[#1E48C7] text-[#0E329F] text-base hover:bg-[#f0f0f0] font-medium py-4 px-7 rounded-md"
                        >
        ...
        <div className="absolute inset-x-0 bottom-20 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 256 256" className="text-[#0E329F]">
